...
namespace EventBooking.Service
{
    public interface IEventBookingRepository
    {
        ...
        Task<string> RegisterDB(Authentication ObjAuthentication, string userID, int otp);
        ...
        Task<string> OTPGenerationDB(ObjOTPGenerationRequest ObjOTPGeneration, string otp);

        Task<string> OTPVerificationDB(OTPVerificationRequest ObjOTPVerificationRequest);
    }
}
