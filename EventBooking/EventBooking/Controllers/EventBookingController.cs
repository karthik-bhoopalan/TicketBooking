...
namespace EventBooking.Controllers
{
    ...
    public class EventBookingController : Controller
    {
        ...
        public async Task<IActionResult> OTPGeneration(ObjOTPGenerationRequest ObjOTPGeneration)
        {
            ...
            bool otpCheck = _eventBookingService.SendOTP("karthik.moni1994@gmail.com", ObjOTPGeneration.Email, "Event Booking Authentication OTP", msg);
        ...
        public async Task<IActionResult> OTPVerification(OTPVerificationRequest ObjOTPVerificationRequest)
        {

            string ResponseMessage = await _eventBookingService.OTPVerification(ObjOTPVerificationRequest);
