...
namespace EventBooking.Service
{
    public class EventBookingRepository : IEventBookingRepository
    {
        ...
        public async Task<string> RegisterDB(Authentication ObjAuthentication, string userID)
        {
            string ResponseMessage = "";
            try
            {
                ...
                ResponseMessage = await _IDBLayercs.ExecuteAsyncSql(param, queryString, 6);
